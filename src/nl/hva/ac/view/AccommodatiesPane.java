...
public class AccommodatiesPane extends GridPane {
    ...
    private void init() {
        ...
        Button sorteer = new Button("Sorteer");
        sorteer.setPrefSize(BTN_WIDTH, BTN_HEIGHT);
        sorteer.setId("Sorteer");
        
        Button opslaan = new Button("Opslaan");
        opslaan.setPrefSize(BTN_WIDTH, BTN_HEIGHT);
        opslaan.setId("Opslaan");
        
        Button lezen = new Button("Lezen");
        lezen.setPrefSize(BTN_WIDTH, BTN_HEIGHT);
        lezen.setId("Lezen");
        
        this.add(sorteer, 0, 3);
        this.add(opslaan, 0, 4);
        this.add(lezen, 0, 5);
